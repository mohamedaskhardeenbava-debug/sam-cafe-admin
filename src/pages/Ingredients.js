      ...
      {showForm && (
        <div className="ingredient-modal-overlay">
          <div className="ingredient-modal">
            ...
            <div className="form-group">
              <label>Ingredient Image</label>
              <input type="file" accept="image/*" onChange={handleIngredientImageUpload} />
              {imagePreview && (
                <img
                  src={imagePreview}
                  alt="preview"
                  ...
                  <label className="checkbox-item" key={cat.id}>
                    <input
                      ...
                      onChange={(e) => {
                        const updated = e.target.checked
                          ? [...formData.usedInCategories, cat.id]
                          : formData.usedInCategories.filter((c) => c !== cat.id);
            ...
            <div className="form-group">
              ...
              <input
                ...
                value={formData.pricePer100g}
                onChange={(e) =>
                  setFormData({ ...formData, pricePer100g: e.target.value })
                }
              />
            </div>

            <div className="form-group">
              <label>Stock Remaining (kg)</label>
              <input
                type="number"
                value={formData.stockRemaining}
                onChange={(e) =>
                  setFormData({ ...formData, stockRemaining: e.target.value })
                }
              />
            </div>
